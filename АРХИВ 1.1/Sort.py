...
print("Горохов Андрей 14122\nПрограмма сортирует предложеный файл с числами, а результат сохраняет в файл results.txt + возможность создать тестовый файл nums.txt\nРеализован метод сортировки слияением через рекурсию\n")
