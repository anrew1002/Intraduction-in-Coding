...
def ask_question_block(frm,question,answers,var=0):
    ...
    Button(frm, text="Start", command=lambda e=frm: Next(e,question,answers,var) ).pack()
...
def end(frm,question):
    ...
    print(count_ans/int(len(question)))
    results="Кол-во правильных: "+ str(count_ans) + " из "  + str(len(question))+ " " + str(count_ans/len(question)*100)[:-2] + "%"
